...
void T1(){
  ...
  // CK1:     [[BB:%.*]] = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 0
  // CK1:     [[SB:%.*]]  = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 0
  // CK1:     [[ETB:%.*]]  = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 31
  // CK1:     [[EB:%.*]] = getelementptr inbounds double, double* [[ETB]], i64 1
  ...
  // CK1:     [[BA:%.*]] = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 0
  // CK1:     [[SA:%.*]]  = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 2
  // CK1:     [[ETA:%.*]]  = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 31
  // CK1:     [[EA:%.*]] = getelementptr inbounds double, double* [[ETA]], i64 1
  ...
  // CK1:     [[EBPTRS0:%.*]] = getelementptr inbounds i8*, i8** [[BPTRS]], i32 0
  // CK1:     [[EPPTRS0:%.*]] = getelementptr inbounds i8*, i8** [[PPTRS]], i32 0
  // CK1:     [[ESIZES0:%.*]] = getelementptr inbounds i64, i64* [[SIZES]], i32 0
  // CK1:     store i8* {{.*}}, i8** [[EBPTRS0]]
  // CK1:     store i8* {{.*}}, i8** [[EPPTRS0]]
  // CK1:     store i64 {{.*}}, i64* [[ESIZES0]]
  // CK1:     [[EBPTRS1:%.*]] = getelementptr inbounds i8*, i8** [[BPTRS]], i32 1
  // CK1:     [[EPPTRS1:%.*]] = getelementptr inbounds i8*, i8** [[PPTRS]], i32 1
  // CK1:     [[ESIZES1:%.*]] = getelementptr inbounds i64, i64* [[SIZES]], i32 1
  // CK1:     store i8* {{.*}}, i8** [[EBPTRS1]]
  // CK1:     store i8* {{.*}}, i8** [[EPPTRS1]]
  // CK1:     store i64 {{.*}}, i64* [[ESIZES1]]

  // Begin data environment
  // CK1:     call void @__tgt_target_data_begin(i32 1, i32 2, i8** [[BPTRS]], i8** [[PPTRS]], i64* [[SIZES]], i32* getelementptr inbounds ([2 x i32], [2 x i32]* [[MT1]], i32 0, i32 0))
  
  #pragma omp target data map(to: B[0:32]) map(from: A[2:30]) device(1)
  {
    // Base pointer, start and end address of C map
    // CK1:     [[BC:%.*]] = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 0
    // CK1:     [[SC:%.*]]  = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 2
    // CK1:     [[ETC:%.*]]  = getelementptr inbounds [32 x double], [32 x double]* %{{.*}}, i32 0, i64 31
    // CK1:     [[EC:%.*]] = getelementptr inbounds double, double* [[ETC]], i64 1
    ...
    // CK1:     [[TGT_EBPTRS0:%.*]] = getelementptr inbounds i8*, i8** [[TGT_BPTRS]], i32 0
    // CK1:     [[TGT_EPPTRS0:%.*]] = getelementptr inbounds i8*, i8** [[TGT_PPTRS]], i32 0
    // CK1:     [[TGT_ESIZES0:%.*]] = getelementptr inbounds i64, i64* [[TGT_SIZES]], i32 0
    // CK1:     store i8* {{.*}}, i8** [[TGT_EBPTRS0]]
    // CK1:     store i8* {{.*}}, i8** [[TGT_EPPTRS0]]
    // CK1:     store i64 {{.*}}, i64* [[TGT_ESIZES0]]
    // CK1:     [[TGT_EBPTRS1:%.*]] = getelementptr inbounds i8*, i8** [[TGT_BPTRS]], i32 1
    // CK1:     [[TGT_EPPTRS1:%.*]] = getelementptr inbounds i8*, i8** [[TGT_PPTRS]], i32 1
    // CK1:     [[TGT_ESIZES1:%.*]] = getelementptr inbounds i64, i64* [[TGT_SIZES]], i32 1
    // CK1:     store i8* {{.*}}, i8** [[TGT_EBPTRS1]]
    // CK1:     store i8* {{.*}}, i8** [[TGT_EPPTRS1]]
    // CK1:     store i64 {{.*}}, i64* [[TGT_ESIZES1]]
    // CK1:     [[TGT_EBPTRS2:%.*]] = getelementptr inbounds i8*, i8** [[TGT_BPTRS]], i32 2
    // CK1:     [[TGT_EPPTRS2:%.*]] = getelementptr inbounds i8*, i8** [[TGT_PPTRS]], i32 2
    // CK1:     [[TGT_ESIZES2:%.*]] = getelementptr inbounds i64, i64* [[TGT_SIZES]], i32 2
    ...
    // CK1:     call i32 @__tgt_target(i32 1, i8* {{.*}}, i32 3, i8** [[TGT_BPTRS]], i8** [[TGT_PPTRS]], i64* [[TGT_SIZES]], i32* getelementptr inbounds ([3 x i32], [3 x i32]* [[MT2]], i32 0, i32 0))
  ...
  // CK1:     call void @__tgt_target_data_end(i32 1, i32 2, i8** [[BPTRS]], i8** [[PPTRS]], i64* [[SIZES]], i32* getelementptr inbounds ([2 x i32], [2 x i32]* [[MT1]], i32 0, i32 0))
  }
  return;
}
...
void foo ()
{
  ...
  // CK4: [[IFVAL:%[a-zA-Z0-9_\.]+]] = load i32, i32* @IF, align 4
  ...
  // CK4: i32 5, 
  // CK4: i8** %{{[^,]*}}, i8** %{{[^,]*}}, i64* %{{[^,]*}},
  // CK4: i32* getelementptr inbounds ([5 x i32], [5 x i32]* @.tgt_types, i32 0, i32 0))
...
void foo ()
{
  ...
  // CK5-DAG: [[S1:%[0-9]+]] = getelementptr inbounds i64, i64* [[SIZES]], i32 {{[0-9]+}}
  // CK5-DAG: store i64 147456, i64* %{{[0-9]+}}
  // CK5-DAG: [[S2:%[0-9]+]] = getelementptr inbounds i64, i64* [[SIZES]], i32 {{[0-9]+}}
  // CK5-DAG: store i64 147456, i64* %{{[0-9]+}}
  // CK5-DAG: [[S3:%[0-9]+]] = getelementptr inbounds i64, i64* [[SIZES]], i32 {{[0-9]+}}
  // CK5-DAG: store i64 4, i64* %{{[0-9]+}}
  // CK5-DAG: [[S4:%[0-9]+]] = getelementptr inbounds i64, i64* [[SIZES]], i32 {{[0-9]+}}
  // CK5-DAG: store i64 4, i64* %{{[0-9]+}}
  // CK5-DAG: [[S5:%[0-9]+]] = getelementptr inbounds i64, i64* [[SIZES]], i32 {{[0-9]+}}
  // CK5-DAG: store i64 4, i64* %{{[0-9]+}}
  // CK5-DAG: [[S6:%[0-9]+]] = getelementptr inbounds i64, i64* [[SIZES]], i32 {{[0-9]+}}
  // CK5-DAG: store i64 4, i64* %{{[0-9]+}}
  // CK5-DAG: [[S7:%[0-9]+]] = getelementptr inbounds i64, i64* [[SIZES]], i32 {{[0-9]+}}
  // CK5-DAG: store i64 4, i64* %{{[0-9]+}}
...
// CK6: call void @__omptgt__{{[0-9]+}}_[[ID:[0-9a-f]+_[0-9a-f]+]]_()
  ...
  // CK6: [[B1:%[0-9]+]] = getelementptr inbounds i8*, i8** [[BPTRS]], i32 0
  // CK6: [[P1:%[0-9]+]] = getelementptr inbounds i8*, i8** [[PPTRS]], i32 0
  // CK6: store i8* bitcast ([10 x i32]* @GA to i8*), i8** [[B1]]
  // CK6: store i8* bitcast ([10 x i32]* @GA to i8*), i8** [[P1]]
  
  // CK6: [[B2:%[0-9]+]] = getelementptr inbounds i8*, i8** [[BPTRS]], i32 1
  // CK6: [[P2:%[0-9]+]] = getelementptr inbounds i8*, i8** [[PPTRS]], i32 1
  // CK6: store i8* bitcast ([10 x i32]* @GB to i8*), i8** [[B2]]
  // CK6: store i8* bitcast (i32* getelementptr inbounds ([10 x i32], [10 x i32]* @GB, i32 0, i64 1) to i8*), i8** [[P2]]
  
  // CK6: call void @__tgt_target_data_update(i32 -1, i32 2, i8** [[BPTRS]], i8** [[PPTRS]], i64* [[SIZES]], i32* getelementptr inbounds ([2 x i32], [2 x i32]* @.update_types, i32 0, i32 0))
